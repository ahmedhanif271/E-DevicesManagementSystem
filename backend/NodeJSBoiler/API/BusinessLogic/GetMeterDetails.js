const  Model  = require("../BusinessLogic/Modules/MeterDetails");

class GetMeterDetails
{
    ...
    {
        message.LIST = await Model.getMeterDetails(message)
...
module.exports= new GetMeterDetails();
